...
const liftTransitions: TransitionMap<
    LiftState | OperationalState | MaintenanceState | EmergencyState,
    LiftEvent,
    LiftContext
> = {
    operational: {
...
const liftMachine = createStateMachine({
    initialState: 'operational' as LiftState,
    context: liftContext,
